...
var $create = Sys.Component.create = function Sys$Component$create(type, properties, events, references, element) {
    ...
    var creatingComponents = FindIt.get_isCreatingComponents();
    ...
    if (component.get_id()) {
        FindIt.addComponent(component);
    }
    if (creatingComponents) {
        FindIt._createdComponents[FindIt._createdComponents.length] = component;
        if (references) {
            FindIt._addComponentToSecondPass(component, references);
        }
        else {
            component.endUpdate();
        }
...
Sys._Application = function Sys$_Application() {
    ...
    function Sys$_Application$_domReady() {
        ...
        function init() { FindIt.initialize(); }
        var onload = function() {
